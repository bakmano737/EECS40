...
/**
 * Pinky is the pink ghost, hence the name. Pinky is the "ambusher" meaning
 * he tries to cut pacman off.
 */
public class Pinky extends Ghost 
{
	...
	public Pinky(Bitmap bmp, Player player, int x, int y, int speed) 
	{
